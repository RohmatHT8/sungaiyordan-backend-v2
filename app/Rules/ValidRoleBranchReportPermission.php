...
class ValidRoleBranchReportPermission implements Rule
{
    protected $message;
    protected $attribute;
    ...
    public function passes($attribute, $value)
    {
        ...
        $otherIds = ReportPermissionMapping::where($this->attribute,$value)->whereIn($this->otherAttribute,$this->otherIds)
            ->when(!empty($this->id),function ($q){
                $q->where('report_permission_setting_id','!=',$this->id);
